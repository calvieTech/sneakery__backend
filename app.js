...
app.use(
  '/api/uploads/avatars',
  express.static(path.join('uploads', 'avatars'))
);
app.use(
  '/api/uploads/sneakers',
  express.static(path.join('uploads', 'sneakers'))
);
...
app.use((error, req, res, next) => {
  ...
  res.json({
    message: error + ' in app.js' || 'An unknown error occurred! in app.js',
  });
});
